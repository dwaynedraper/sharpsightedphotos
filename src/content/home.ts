export const homeContent = {
    ...
    explanatory: {
        headline: "This Is Concierge-Level Production for",
        headlineAccent: "People Who Can't Be Templated",
        p1: "Most photographers build a system and expect you to fit into it. I do the opposite. I build the system around you.",
        p2: "You'll never be rushed. You'll never be squeezed into someone else's idea of who you should be. And you'll never be surprised by how I use your images—the Discovery Hour Agreement makes it legally binding that I won't use any photo or recording without your explicit approval.",
